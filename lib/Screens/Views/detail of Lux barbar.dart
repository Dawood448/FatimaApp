...
class LuxbarbarDetailScreen extends StatelessWidget {
  const LuxbarbarDetailScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          const textWidget(text: "Lux barber", style: TextStyle(color: Colors.grey),),
          const textWidget(text: "Hair Color treatments", style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
          ...
          Row(
            ...
            children:  [
              ...
              InkWell(child: const Card(elevation: 5,child: GradButton(tex: "Book This")),onTap: (){},),
            ],
          ),
